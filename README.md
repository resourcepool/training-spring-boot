...
## II. SetUp Intellij 
### 1. Création compte 
Intellij est un IDE super complet et est devenu un indispensable pour le dévelopement de projet Java. <br> <br>

Avec ses recherches de fichiers optimisées, auto-complétions et raccourcis à gogo, Intellij améliore grandement l'expérience de développement. Le Graal étant que maven est intégré de base et que tu peux télécharger n'importe quelle version de Java depuis IntelliJ (non ce n'est pas un rêve !)<br><br>

Cerise sur le gateaux grâce à ton compte EPF, tu peux obtenir une licence gratuite de la version payante (ultimate). <br>
